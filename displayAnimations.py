...
def initializeAnimations(self):
        ...
        # GOOFY PERSONA
        imageMan = Image.open(os.path.join(os.path.dirname(__file__), "img", "goofyMan.png"))
        ...
        # GOOFY PERSONA
        imageCouple = Image.open(os.path.join(os.path.dirname(__file__), "img", "goofyCouple.png"))
        ...
        # bankAdviser
        imgBankAdviser = Image.open(os.path.join(os.path.dirname(__file__), "img", "bankAdviser.png"))
        self.imgBankAdviser=imgBankAdviser.resize((100,100))   
        self.imgBankAdviser = ImageTk.PhotoImage(self.imgBankAdviser)
        # bizAdviser
        imgBizAdviser = Image.open(os.path.join(os.path.dirname(__file__), "img", "bizAdviser.png"))
        self.imgBizAdviser=imgBizAdviser.resize((100,100))   
        self.imgBizAdviser = ImageTk.PhotoImage(self.imgBizAdviser)
        # scamAdviser
        imgScamAdviser = Image.open(os.path.join(os.path.dirname(__file__), "img", "scamAdviser.png"))
        ...
        imageAdviserYoungGirl = Image.open(os.path.join(os.path.dirname(__file__), "img", "rainbowGirl.png"))
        ...
        imageAdviserCharityLady = Image.open(os.path.join(os.path.dirname(__file__), "img", "charityLady.png"))
        ...
        imageAdviserDrugDealer = Image.open(os.path.join(os.path.dirname(__file__), "img", "drugDealer.png"))
        ...
        imageAdviserOld = Image.open(os.path.join(os.path.dirname(__file__), "img", "oldMan.png"))
        ...
        imageAdvisersHall = Image.open(os.path.join(os.path.dirname(__file__), "img", "advisersHall.png"))
        ...
        imageCallAdviserIcon = Image.open(os.path.join(os.path.dirname(__file__), "img", "callAdviserIcon.png"))
