...
#     self.lstats.place(x=20, y=30)
    ...
    self.bretire = Button(text="Retire", width=6, font=("Segoe UI", 8),
    ...
    self.bskip = Button(text="2w Rest", width=6, font=("Segoe UI", 8),
                            command=lambda: personal.do_bvacation(self, engine))
    self.bskip.place(x=830, y=220)


    # ----- Game: (1) save / (2) load
    # self.labelbsave=Label(text="-0⚡", width=4, background="lightgreen", foreground="darkred")   
    # self.labelbsave.place(x=870,y=180) 
    self.bsave = Button(text="Save", width=5, font=("Segoe UI", 8),
                            command=lambda: personal.do_bsave(self,engine))
    self.bsave.place(x=910, y=180)

    # self.labelbload=Label(text="-0⚡", width=4, background="lightgreen", foreground="darkgreen")   
    # self.labelbload.place(x=7870,y=220) 
    self.bload = Button(text="Load", width=5, font=("Segoe UI", 8),
                            command=lambda: personal.do_bload(self, engine))
    self.bload.place(x=910, y=220)